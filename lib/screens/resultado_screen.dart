...
class ResultadoScreen extends StatelessWidget {
  ...
  static const Map<String, Map<String, List<Recomendacion>>> _recomendacionMap = {
    "Bajo": {
      "Musica": [
        Recomendacion("El condor pasa", "https://youtu.be/8kQZHYbZkLs"),
        Recomendacion("Laguna el Tabacal", "https://youtu.be/-grEOU2y-Tk"),
      ],
      "Video": [
        Recomendacion("Alivio de estres", "https://www.youtube.com/live/3GJ-Ljnq1ME"),
        Recomendacion("Relajacion Visual", "https://youtu.be/7FgZGMdtsT0"),
      ]
    },
    "Medio": {
      "Musica": [
      ...
      "Video": [
        Recomendacion("Meditacion", "https://youtu.be/1_mQTOsxack"),
    ...
    "Alto": {
      ...
      "Video": [
        Recomendacion("Relajacion visual", "https://youtu.be/7FgZGMdtsT0"),
        Recomendacion("Escenarios naturales", "https://youtu.be/BHACKCNDMW8"),
      ]
    },
  };
          ...
          children: [
            Row(
              children: [
                ...
                const Text("Resultado", style: TextStyle(color: Colors.indigo, fontWeight: FontWeight.bold, fontSize: 20)),
              ],
            ),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text("Resultado", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.orange)),
              const SizedBox(height: 10),
              const Text(
              ...
              const Text("Su nivel de estrés es:", style: TextStyle(color: Colors.black54)),
              const SizedBox(height: 10),
              _buildLevelBox(),
                  ...
                  Expanded(
                      child: _buildActionButton(
                          ...
                          const Color(0xFF99CC33),
                              () => Navigator.push(context, MaterialPageRoute(builder: (context) => const InstitucionesScreen()))
                      )
                  ),
