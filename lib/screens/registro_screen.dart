  ...
  class _RegistroScreenState extends State<RegistroScreen> {
      ...
      try {
        ...
        if (res.user != null) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text("¡Cuenta creada con éxito! Bienvenidx.")),
          );
        }
    ...
    void dispose() {
      ...
      _passwordCtrl.dispose(); _celularCtrl.dispose(); _emergenciaNombreCtrl.dispose();
      _emergenciaTelCtrl.dispose(); _codigoCtrl.dispose(); _carreraCtrl.dispose();
      _centroCtrl.dispose(); _cicloCtrl.dispose(); _generoCtrl.dispose();
      super.dispose();
    }
  }