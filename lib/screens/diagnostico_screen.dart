...
import '/widgets/question_card.dart';
  ...
  class _DiagnosticoScreenState extends State<DiagnosticoScreen> {
    ...
    final List<PreguntaEEP> _preguntas = [
      PreguntaEEP("1. ¿Con qué frecuencia ha estado afectado por algo que ha ocurrido inesperadamente?"),
      PreguntaEEP("2. ¿Con qué frecuencia se ha sentido incapaz de controlar las cosas importantes en su vida?"),
      PreguntaEEP("3. ¿Con qué frecuencia se ha sentido nervioso o estresado?"),
      PreguntaEEP("4. ¿Con qué frecuencia ha estado seguro sobre su capacidad para manejar sus problemas personales?", esInversa: true),
      PreguntaEEP("5. ¿Con qué frecuencia ha sentido que las cosas le van bien?", esInversa: true),
      PreguntaEEP("6. ¿Con qué frecuencia ha sentido que no podía afrontar todas las cosas que tenía que hacer?"),
      PreguntaEEP("7. ¿Con qué frecuencia ha podido controlar las dificultades de su vida?", esInversa: true),
      PreguntaEEP("8. ¿Con qué frecuencia se ha sentido que tenía todo bajo control?", esInversa: true),
      PreguntaEEP("9. ¿Con qué frecuencia ha estado enfadado porque las cosas que le han ocurrido estaban fuera de su control?"),
      PreguntaEEP("10. ¿Con qué frecuencia ha sentido que las dificultades se acumulan tanto que no puede superarlas?"),
    ];

    //bool get _todoRespondido => _preguntas.every((p) => p.respuestaSeleccionada != null);
    int get _totalRespondidas => _preguntas.where((p) => p.respuestaSeleccionada != null).length;
          ...
          child: Column(
            ...
            children: [
              Align(
                ...
                child: IconButton(
                  icon: const Icon(Icons.arrow_back_ios, color: Colors.orange, size: 22),
    ...
    Widget _buildQuestionsPage(int start, int end) {
      bool rangoRespondido = _preguntas.sublist(start, end).every((p) => p.respuestaSeleccionada != null);
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: rangoRespondido ? const Color(0xFF90CAF9) : Colors.grey[400],
                    shape: const StadiumBorder(),
                    padding: const EdgeInsets.symmetric(vertical: 15),
                  ),
                  onPressed: rangoRespondido
                      ? (end == 10 ? _finalizarDiagnostico : () {
